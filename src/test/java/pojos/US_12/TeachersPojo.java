...
public class TeachersPojo implements Serializable {
	...
	public TeachersPojo(int userId, String username, String name, String surname, String birthDay, String ssn, String birthPlace, String phoneNumber, String gender, String email, boolean advisorTeacher) {
		this.userId = userId;
