package pojos.US_20_Pojos;

import java.util.List;
import java.io.Serializable;

public class MeetEditResponsePojo implements Serializable {
	private int id;
	...
	public MeetEditResponsePojo() {
	}

	public MeetEditResponsePojo(int id, String description, String date, String startTime, String stopTime, int advisorTeacherId, String teacherName, String teacherSsn, List<StudentsPojo> students) {
		this.id = id;
