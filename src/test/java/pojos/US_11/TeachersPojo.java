...
public class TeachersPojo implements Serializable {
	...
	public TeachersPojo(String birthDay, String birthPlace, String phoneNumber, boolean advisorTeacher, String gender, String surname, String name, int userId, String email, String username, String ssn) {
		this.birthDay = birthDay;
		this.birthPlace = birthPlace;
		this.phoneNumber = phoneNumber;
		this.advisorTeacher = advisorTeacher;
